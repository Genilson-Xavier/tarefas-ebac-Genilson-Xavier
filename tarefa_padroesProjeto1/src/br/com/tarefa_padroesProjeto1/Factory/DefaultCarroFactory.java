...
public class DefaultCarroFactory {
	  public static Carro construirCarro(TipoCarro modelo)
	  {
	    ...
	    {
	      case PASSEIO:
	      Carro = new CarroPequeno(Localizacao.DEFAULT);
	      break;
	 
	      case SEDAN:
	      Carro = new CarroSedan(Localizacao.DEFAULT);
	      break;
	 
	      case LUXO:
	      Carro = new CarroLuxo(Localizacao.DEFAULT);
	      break;
