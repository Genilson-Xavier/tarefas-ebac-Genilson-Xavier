...
import br.com.tarefa_colecoes.Model.Pessoa;
...
public class tarefa_colecoes2 {
	public static void main(String[] args) {
		...
		List<Pessoa> dtoPessoao = new ArrayList<Pessoa>();
					...
					case 1:
						switch(listPessoa[y].charAt(0)) {
							...
							case 'F':
								...
								break;
							default:
								dtoPessoao.add(new Pessoa(nome,'O'));
								break;
						}
						break;
					default:
		...
		if(dtoPessoao != null && !dtoPessoao.isEmpty()) {
			System.out.println(" genero Outro: "+dtoPessoao.toString());
		}
		s.close();
	}
}
